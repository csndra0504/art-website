...
// Everything the cart shows, shared by the drawer and the full /cart page, so
// the two can never disagree about totals or checkout behaviour.
// `onBrowse` is the empty cart's way back to shopping: closing the drawer, or
// leaving the page.
export function CartContents({ onBrowse }: { onBrowse: () => void }) {
